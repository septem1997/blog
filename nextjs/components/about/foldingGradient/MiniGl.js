export default class MiniGl {
  constructor(canvas, width, height, debug = false) {
    ...
    //   debug_output = -1 !== window.location.search.toLowerCase().indexOf("debug=webgl")
      ...
      Object.defineProperties(_miniGl, {
          ...
          value: class {
            constructor(vertexShaders, fragments, uniforms = {}) {
              ...
              material.vertexSource = `\n${prefix}\nattribute vec4 position;\nattribute vec2 uv;\nattribute vec2 uvNorm;\n${getUniformVariableDeclarations(_miniGl.commonUniforms, "vertex"
                ...
                // console.log("Attaching Uniforms...");
                material.attachUniforms(void 0, _miniGl.commonUniforms);
                material.attachUniforms(void 0, material.uniforms);
                // console.log(_miniGl.commonUniforms);
            ...
            attachUniforms(name, uniforms) {
              ...
              void 0 === name ? Object.entries(uniforms).forEach(([name, uniform]) => {
                  ...
                  }) : "array" == uniforms.type ? uniforms.value.forEach((uniform, i) =>
                    material.attachUniforms(`${name}[${i}]`, uniform)
                  ) : "struct" == uniforms.type ? Object.entries(uniforms.value).forEach(([uniform, i]) =>
                ...
                //   console.log(material.uniformInstances)
            }
          },
        },
        Uniform: {
          ...
          value: class {
            ...
            setSize(width = 1, height = 1, orientation = "xz") {
              ...
              geometry.width = width;
                ...
                if (geometry.attributes.position.values) {
                    if (geometry.attributes.position.values.length === 3 * geometry.vertexCount) {
        ...
        Mesh: {
          ...
          value: class {
            ...
            //   console.log(this.material.uniformInstances);
